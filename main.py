...
if selected=="Malaria":
    img1=Image.open("C:/Users/saite/OneDrive/Desktop/bio/images/image-removebg-preview (32).png")
    st.image(img1)
...
if selected=="Pneumonia":
    ...
    img2=Image.open('C:/Users/saite/OneDrive/Desktop/bio/images/image-removebg-preview (31).png')
    st.image(img2)
...
if selected=="Heart Disease":
    loaded_model=tf.keras.models.load_model('my_model.h5')
    img2=Image.open('C:/Users/saite/OneDrive/Desktop/bio/images/ss.png')
    st.image(img2)
